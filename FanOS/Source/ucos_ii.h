...
/* =============== ��˵��Ⱥ��ĳ������� =============== */
#define USAGE_MAX_COUNT           10000u       /* CPUʹ����������ֵ */
#define DIFF_COUNT                10u          /* ����������ֵ */
#define OS_MULTI_CORE_SCHED_DELAY 10000u      /* ���˵��ȼ�� */
//#define MAX_CORE_NUMS             5u           /* ���֧�ֺ����� */
#define ALL_CORES_ID              0xFFu        /* ��ʼ������ʱ���к���ID */

/* ������ݴ�����س��� */
#define SLAVE_DATA_TRANSFER_WAIT_DELAY 1000u   /* ��˵ȴ��������ݴ�������ʱ */
#define OS_QUEUE_SIZE                  6u      /* ������д�С */
#define OS_SEND_DATA_DELAY             10u		 /* ��ǰһ�����ݻ�δ�������ʱ��Ҫ����ʱ */
#define OS_SEND_DATA_TIMEOUT           1000    /* ���ݴ���ĳ�ʱ���� */
...
/* =============== ����������Ͷ��� =============== */
/* �������ͱ�ʶ */
#define GET_STACK_DATA        0x01u  /* ��ȡջ���� */
#define SEND_STACK_DATA       0x02u  /* ����ջ���� */
#define GET_VARIABLE_DATA     0x03u  /* ��ȡ�������� */
#define SEND_VARIABLE_DATA    0x04u  /* ���ͱ������� */
#define GET_CPU_USAGE         0x05u  /* ��ȡCPUʹ���� */
#define TASK_SWITCH_REQUEST   0x06u  /* �����л����� */
#define IS_BUSY               0x07u  /* ���æµ״̬ */
#define SEND_DATA_FINISHED    0x08u  /* �����Ѿ���ɷ��� */

#define RES_OK                0x0Fu  /* ��Ӧ�ɹ� */
#define RES_BUSY              0x02u  /* ��Ӧæµ */
#define NOT_ALLOWED_SWITCH    0x03u  /* �������л� */
#define TASK_NOT_ACTIVATE     0x04u  /* ����δ���� */
#define TASK_IS_ACTIVATE      0x05u  /* �����Ѽ��� */
#define PROTOCOL_ERROR        0x06u  /* Э����� */
#define STACK_NOT_CREATED     0x07u  /* ջδ���� */
#define TIME_OUT              0x08u  /* ��ʱ */
...
/* ����������ȼ� */
#define OS_MULTI_SCHED_PRIO   0u    /* �����������ȼ� */
#define OS_MULTI_SUSPEND_PRIO 1u    /* �����������ȼ� */
#define OS_MULTI_DATA_PRIO    2u    /* ���ݴ����������ȼ� */

#define OS_BUSY_WAIT_DELAY    10u   /* æ�ȴ���ʱ */

/* =============== ������������ж� =============== */
/**
 * @brief �ж����ȼ��Ƿ�ΪOS�������
 * @param prio �������ȼ�
 * @return TRUE(1) ��OS����FALSE(0) ����
 */
...
/* =============== �ⲿ�������� =============== */
extern uint8_t Task_Switch_Buffer[512];  /* �����л������� */
extern uint8_t OSDevAddrs[];             /* �豸��ַ���� */
extern uint32_t total_count;             /* ��������� */
extern uint8_t OSCoreID;                 /* ��ǰ����ID */
extern uint8_t OSDevNums;                /* �豸���� */
extern uint8_t OSMinCountPrio;           /* ��С�����������ȼ� */
extern uint16_t OSMinCount;              /* ��С���� */
extern uint8_t OSSuspendTaskPrio;        /* �����������ȼ� */

/* �ź������� */
extern OS_EVENT* GetStackSem;            /* ��ȡջ�����ź��� */
extern OS_EVENT* SendDataSem;            /* ���������ź��� */
extern OS_EVENT* TaskSuspendSem;         /* ��������ź��� */
extern OS_EVENT* DataTransferSem;        /* ���ݴ����ź��� */
...
#endif
>>>>>>> 7044435e082b271049b1b184db19b725a4542d78
